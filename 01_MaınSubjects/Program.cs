...
namespace _01_MaınSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //int totalHamburgerPrice = 0; //0 yazmak illa başlangıç değeri atanmak zorunda değiliz.
            //int totalCookPrice;
            //int totalWaterPrice;
            //int totalFriesPrice;
            //int totalPizzaPrice;
            ...
            //totalCookPrice = cokeCount * cokePrice;
